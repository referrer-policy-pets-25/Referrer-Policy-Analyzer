...
class Hasher():
    def __init__(self):
        ...
        hashes['sha3_224'] = lambda x: hashlib.sha3_224(x.encode()).hexdigest()
        hashes['sha3_256'] = lambda x: hashlib.sha3_256(x.encode()).hexdigest()
        hashes['sha3_384'] = lambda x: hashlib.sha3_384(x.encode()).hexdigest()
        hashes['sha3_512'] = lambda x: hashlib.sha3_512(x.encode()).hexdigest()
